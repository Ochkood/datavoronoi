...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        setError("");
        const parsed = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$validators$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loginSchema"].safeParse(formData);
        if (!parsed.success) {
        ...
        setIsLoading(true);
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loginApi"])(formData.email, formData.password);
...
_s(LoginPage, "qzAPI2KNeabSCN1rOIJHYKyTEnY=", false, function() {
    return [
...
//# sourceMappingURL=_5d829f48._.js.map